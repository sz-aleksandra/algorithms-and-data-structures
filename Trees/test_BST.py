...
def test_BinarySearchTree():
    ...
    for i in range(len(digits)):
        ...
        assert tree.root.right_child.height == 2
        assert tree.root.right_child.left_child.value == 1
        assert tree.root.right_child.left_child.height == 1
        assert tree.root.right_child.right_child.value == 6
        assert tree.root.right_child.right_child.height == 1
...
def test_BTS_find_node():
    ...
    for i in range(len(digits)):
        tree.insert_rec(digits[i], tree.root)
    assert tree.find_rec(10)[1] is None
    assert tree.find_rec(0)[0] is None
    assert tree.find_rec(0)[1].value == 0
    assert tree.find_rec(8)[0].value == 6
    assert tree.find_rec(8)[0].right_child.value == 8
    assert tree.find_rec(8)[1].value == 8
    assert tree.find_rec(8)[1].right_child.value == 9
    assert tree.find_rec(8)[1].left_child.value == 7
...
def test_BST_get_node_height():
    digits = [0, 2, 1, 6, 5, 8, 4, 7, 9, 3]
    tree = BinarySearchTree()
    for i in range(len(digits)):
        tree.insert_rec(digits[i], tree.root)
    assert tree.get_node_height(tree.root) == 6
    assert tree.get_node_height(tree.root.right_child.right_child.right_child.right_child) == 1
    assert tree.get_node_height(tree.root.right_child.right_child) == 4
